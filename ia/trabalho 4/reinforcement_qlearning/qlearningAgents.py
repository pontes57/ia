...
class QLearningAgent(ReinforcementAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        self.Qv[state,action]=((1-self.alpha)*self.getQValue(state,action)+self.alpha*(reward+self.discount*self.getValue(nextState)))
        return
        util.raiseNotDefined()
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        """
        self.Qv[state,action]=self.weights.__mul__(self.featExtractor)
        return self.Qv[state,action]
        util.raiseNotDefined()
